...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * Register the Figtree font family (regular, bold, italic, bold_italic)
         */
        'font_family' => [
            'Figtree' => [
                'R'  => resource_path('fonts/Figtree/Figtree-Regular.ttf'),
                'B'  => resource_path('fonts/Figtree/Figtree-Bold.ttf'),
                'I'  => resource_path('fonts/Figtree/Figtree-Italic.ttf'),
                'BI' => resource_path('fonts/Figtree/Figtree-BoldItalic.ttf'),
            ],
        ],
